...
async def start(client,message):
	...
	await message.reply_text("Hello iam Pdisk Uploader Bot",reply_to_message_id = message.message_id,reply_markup=InlineKeyboardMarkup([ [ InlineKeyboardButton("Support" ,url="https://t.me/hexbotsdg") ], [InlineKeyboardButton("updates Channel", url="https://t.me/HEXBOTS") ]  ]  ) 
        )
